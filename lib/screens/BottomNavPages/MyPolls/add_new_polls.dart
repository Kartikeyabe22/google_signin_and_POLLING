...
import 'package:polling/providers/db_provider.dart';
                    ...
                    Consumer<DbProvider>(
                      builder: (context, db,child) {
                        ...
                        return GestureDetector(
                         ...
                         db.addPoll(question: question.text.trim(), duration: duration.text.trim(), options: options);
                            }
                          },
                          child: Container(
                            height: 50,
